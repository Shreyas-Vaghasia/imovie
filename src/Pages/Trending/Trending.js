...
export default function Trending() {
    ...
    let getMovies = async () => {
        ...
        const data = await axios.get(`https://api.themoviedb.org/3/movie/popular?api_key=6db49639138ee4ac1b9a3a592334ab74&language=en-US&page=${page}&with_genres=${genIds}`)
            .then(res => {
